...
function createGround() {
  ...
  const groundTexture = textureLoader.load('./imgs/grasslight-big.jpg')
...
window.addEventListener('click', function (e) {
  if (controls.enabled == true) {
    ...
    if (e.which === 1) {
      ...
      brickBumpMat.map = textureLoader.load('./imgs/brickNormal.jpg')
      brickBumpMat.bumpMap = textureLoader.load('./imgs/brickBumpMap.jpg')
